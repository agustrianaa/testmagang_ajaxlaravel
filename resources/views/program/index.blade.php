...
<body class="bg-light">
                ...
                <table class="table table-striped" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-5">Sumber Dana</th>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <label for="nama" class="col-sm-2 col-form-label">Sumber Dana</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='nama' id="sumber_dana">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='program' id="keterangan">
                    </div>
                </div>
        <!-- AKHIR FORM -->
        </div>
